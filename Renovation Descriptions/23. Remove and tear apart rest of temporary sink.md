...
- Der er **ingen** afspærringsventiler på varmt/koldt (kobberrør direkte op til armatur - se billede nedenfor). - de er til gengæld inde i kasse ved siden af bathroom 1, i hjørnet af entrance.
...
2. **Luk vandforsyning ved siden af Bathroom 1.**
   - Luk for de to ventiler der forsyner køkkenet med vand - brug skruetrækker.
